#############################################################################
# Makefile for building: AlsaGui
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  AlsaGui.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile AlsaGui.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = AlsaGui1.0.0
DISTDIR = /home/gprashant/AlsaGuiProject/.tmp/AlsaGui1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath-link,/usr/lib/x86_64-linux-gnu
LIBS          = $(SUBLIBS) -lasound /usr/lib/x86_64-linux-gnu/libQt6Widgets.so /usr/lib/x86_64-linux-gnu/libQt6Gui.so /usr/lib/x86_64-linux-gnu/libGLX.so /usr/lib/x86_64-linux-gnu/libOpenGL.so /usr/lib/x86_64-linux-gnu/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		AlsaGui.pro AlsaManager.h main.cpp \
		AlsaManager.cpp
QMAKE_TARGET  = AlsaGui
DESTDIR       = 
TARGET        = AlsaGui
...
Makefile: AlsaGui.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents AlsaManager.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp AlsaManager.cpp $(DISTDIR)/
...
main.o: main.cpp AlsaManager.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

AlsaManager.o: AlsaManager.cpp AlsaManager.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AlsaManager.o AlsaManager.cpp
